...
import { checkOtpRestriction, sendOtp, trackOptRequests, validateRegisterationData } from "../utils/auth.helper.js";
...
export const userRegistration = async (req: Request, res: Response,next:NextFunction) => {
    ...
    try {
        ...
        res.status(201).json({message:"OTP send to mail please verify",name,email,password,phone_number,country})
    } catch (error) {
