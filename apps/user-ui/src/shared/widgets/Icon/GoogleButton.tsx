...
const GoogleButton = () => {
  return (
    <button
      ...
      className="flex items-center justify-center gap-3 border border-gray-400 rounded-md px-4 py-2 bg-white text-gray-800 font-medium hover:shadow-md active:bg-gray-100 transition duration-200"
    >
      <svg
        className="w-5 h-5"
        viewBox="0 0 48 48"
      ...
      >
        <path
          ...
          2.38 30.47 0 24 0 14.62 0 6.51 5.38 
        ...
        <path
          ...
          c-.58 2.96-2.26 5.48-4.78 7.18l7.73 
        ...
        <path
          ...
          -6.26 0-11.57-4.22-13.47-9.91l-7.98 
